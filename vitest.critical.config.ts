  ...
  test: {
    ...
    coverage: {
      ...
      include: [
        ...
        "packages/core/src/agent/ParallelToolBatchExecutor.ts",
        "packages/core/src/agent/StepRunner.ts",
        "packages/core/src/agent/ToolResultContent.ts",
        "packages/core/src/evaluation/AcceptanceComparison.ts",
        "packages/core/src/evaluation/OfflineAgentFixture.ts",
        "packages/core/src/evaluation/ScriptedModelProvider.ts",
        ...
        "packages/tools/src/ToolContract.ts",
