...
\section{主要提示方式与过程}
\TODO{概述如何提供题目、代码和证据约束；不得虚构未发生的交互。}

\section{关键交互记录}
\renewcommand{\arraystretch}{1.15}
\begin{longtable}{@{}L{0.06\textwidth}L{0.26\textwidth}L{0.31\textwidth}L{0.25\textwidth}@{}}
  \hline
  序号 & 重要提示词（摘要） & AI回复（摘要） & 采纳及人工修改 \\
  \hline
  1 & \TODO{填写真实提示词} & \TODO{填写真实回复要点} & \TODO{填写采纳与修改} \\
  \hline
\end{longtable}
