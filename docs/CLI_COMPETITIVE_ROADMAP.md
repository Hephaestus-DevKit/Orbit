...
| -------- | -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0       | Parallel subagents         | A dependency DAG scheduler provides bounded concurrency, isolated writer/reviewer orchestration, durable per-agent status/cost records, and a responsive WebUI Mission Control surface with fixed plan and parallel-improvement launch actions | Add steerable durable agent threads, merge-aware write ownership, visible approval ownership, and reusable team presets                                 |
