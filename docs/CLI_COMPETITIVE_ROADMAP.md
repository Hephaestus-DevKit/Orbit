...
| -------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| P0       | Parallel subagents         | A dependency DAG scheduler provides validated scope ownership, isolated writer/reviewer orchestration, durable session-linked agent records, targeted steering, attributed FIFO approvals, heartbeat-backed cross-process leases, explicit interrupted-child resume, provider-neutral team presets, and WebUI Mission Control | Add isolated merge-aware multi-writer orchestration                                                                                                                      |
